...
import ru.orangesoftware.financisto.db.ReadFromSMSBase;
...
public class MainActivity extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    private static final int MENU_SMS_PARS = Menu.FIRST+16; //РџСѓРЅРєС‚ РјРµРЅСЋ РґР»СЏ СЂР°Р±РѕС‚С‹ СЃ СЃРјСЃ
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addSubMenu(0, MENU_SMS_PARS, 0, R.string.sms_pars); //СЃРјСЃ
        return true;
    }
    ...
    private class SMSParsTask extends AsyncTask {
        ...
        @Override
        protected Object doInBackground(Object... objects) {
            ReadFromSMSBase readFromSMSBase= new ReadFromSMSBase(getContentResolver());
            //вытаскиваем все записи (0 - те, которые еще не считывали, 1 - те, которые уже считали)
           Boolean check =  readFromSMSBase.ReadAllLines("0");
            //Здесь нужно сохранить записи
            //-----------------------------------
            //ставим isfinin = 1
            check =  readFromSMSBase.SetIsInFin();

            //readFromSMSBase.ReadAllLines("0");
            //Log.d("SMSLogs", "____________________");
            //readFromSMSBase.ReadAllLines("1");
            return null;
        }
    }
